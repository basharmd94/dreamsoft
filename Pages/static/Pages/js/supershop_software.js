...
document.addEventListener('DOMContentLoaded', () => {
    ...
    faqItems.forEach((item) => {
        ...
        question.addEventListener('click', () => {
            ...
            faqItems.forEach((other) => {
                ...
                const otherQuestion = other.querySelector('.sp-faq-question');
                const otherAnswer = other.querySelector('.sp-faq-answer');
                if (otherQuestion) {
    ...
    if (faqItems.length) {
        ...
        const firstQuestion = firstItem.querySelector('.sp-faq-question');
        const firstAnswer = firstItem.querySelector('.sp-faq-answer');
